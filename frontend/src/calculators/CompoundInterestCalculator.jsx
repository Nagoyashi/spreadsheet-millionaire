...
function calculate(inputs) {
  ...
  for (let y = 0; y <= t; y++) {
    ...
    chartData.push({
      year: y,
      value: Math.round(lump + contrib),
      contributions: Math.round(P + pmt * 12 * y),
    })
  }
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2.5 sm:py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-base sm:text-sm text-gray-800"
              >
